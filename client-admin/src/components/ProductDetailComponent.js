  ...
  render() {
    ...
    return (
      <div className="float-right">
        <h2 className="text-center text-2xl font-bold text-red">PRODUCT DETAIL</h2>
        <form>
          <table >
            <tbody>
              <tr>
                <td>ID</td>
                <td><input className='bg-gray-200 py-1 px-4 border-solid border-2 border-indigo-200 rounded-md w-full mt-3' type="text" value={this.state.txtID} onChange={(e) => { this.setState({ txtID: e.target.value }) }} readOnly={true} /></td>
              </tr>
              <tr>
                <td>Name</td>
                <td ><input className='bg-gray-200 py-1 px-4 border-solid border-2 border-indigo-200 rounded-md w-full mt-3' type="text" value={this.state.txtName} onChange={(e) => { this.setState({ txtName: e.target.value }) }} /></td>
              </tr>
              <tr>
                <td>Price</td>
                <td><input className='bg-gray-200 py-1 px-4 border-solid border-2 border-indigo-200 rounded-md w-full mt-3' type="text" value={this.state.txtPrice} onChange={(e) => { this.setState({ txtPrice: e.target.value }) }} /></td>
              </tr>
              <tr>
                <td>Image</td>
                <td><input className=' py-1 px-4  rounded-md w-full mt-3'   type="file" name="fileImage" accept="image/jpeg, image/png, image/gif" onChange={(e) => this.previewImage(e)} /></td>
              </tr>
              <tr>
                <td>Category</td>
                <td><select className='bg-gray-200 py-1 px-4 border-solid border-2 border-indigo-200 rounded-md w-full mt-3' onChange={(e) => { this.setState({ cmbCategory: e.target.value }) }}>{cates}</select></td>
              </tr>
              <tr>
                <td></td>
