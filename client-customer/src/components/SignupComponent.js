...
class Signup extends Component {
  ...
  render() {
    return (
      <div className="">
        <h2 className="text-center font-lato font-bold  text-4xl ">SIGN-UP</h2>
        <form>
          <table className="align-center font-bold">
            <tbody>
              ...
              <tr>
                <td></td>
                <td><input className='py-1 px-4 py-2 px-2 border-solid border-2 bg-red-500 rounded-md w-full' type="submit" value="SIGN-UP" onClick={(e) => this.btnSignupClick(e)} /></td>
              </tr>
            </tbody>
          </table>
        </form>
